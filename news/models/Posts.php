...
class Posts extends Model
{
    ...
    protected $purgeable = ['send_vk_checkbox'];
...
//        if($this->send_vk_checkbox == 1){
//            $this->send_vk_at = Carbon::now();
//            Log::error("checkbox when 1 is $this->send_vk_checkbox");
//        }
//
//        if($this->send_vk_checkbox == 0){
//            $this->send_vk_at=null;
//            Log::error("checkbox when 0 is $this->send_vk_checkbox");
//        }
    }
